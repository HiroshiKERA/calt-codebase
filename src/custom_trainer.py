...
class CustomPolynomialTrainer(PolynomialTrainer):
    '''
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.compute_metrics = kwargs['compute_metrics'] if 'compute_metrics' in kwargs else self._compute_metrics
    ...
    def evaluate(self, eval_dataset=None, ignore_keys=None, metric_key_prefix="eval"):
        ...
        # currently using the default implementation in PolynomialTrainer class 
